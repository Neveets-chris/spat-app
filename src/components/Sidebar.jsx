...
export default function Sidebar({ page, setPage, open }) {
  return (
    <aside className={`${open ? "w-60" : "w-16"} bg-[#0F2D56] dark:bg-gray-900 flex flex-col transition-all duration-300 shrink-0 border-r border-[#1a3f75] dark:border-gray-800`}>
